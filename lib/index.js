...
var receive = _async(function (port, role) {
...
var init = _async(function (threads) {
  var _exit = false;
  var ports;
  return _invoke(function () {
    if (!threads) {
      ...
      var selves = Object.entries(threads).filter(function (_ref) {
      ...
      var portMap = Object.fromEntries(Object.keys(threads).map(function (r) {
        return [r, {}];
      }));

      for (var _i2 = 0, _Object$keys = Object.keys(threads); _i2 < _Object$keys.length; _i2++) {
        var r = _Object$keys[_i2];

        for (var _i3 = 0, _Object$keys2 = Object.keys(threads); _i3 < _Object$keys2.length; _i3++) {
          var s = _Object$keys2[_i3];
          if (r === s) return;
      ...
      Object.entries(threads).filter(function (_ref3) {
        ...
        return t.postMessage(portMap[r], Object.values(portMap[r]));
      });
