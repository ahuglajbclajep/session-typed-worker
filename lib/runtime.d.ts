...
declare type Message = [string, unknown];
declare type Ports = Record<string, MessagePort>;
declare type Context = {
    ports: Ports;
    queues: Record<string, Message[]>;
};
declare type Workers = Record<string, Window | Worker>;
declare type SelfOrWorkers = DedicatedWorkerGlobalScope | Workers;
declare function init(selfOrWorkers: SelfOrWorkers): Promise<Context | undefined>;
