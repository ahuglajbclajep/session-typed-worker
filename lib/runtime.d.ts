...
declare function send<R extends string, LS extends SelectLocals, L extends keyof LS>(port: Select<R, LS>, role: R, label: L, value: Parameters<LS[L]>[0]): ReturnType<LS[L]>;
declare function recv<R extends string, LS extends OfferLocals>(port: Offer<R, LS>, role: R): Promise<LS>;
